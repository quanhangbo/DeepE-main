...
def load_triples_from_txt(filename, words_indexes=None, parse_line=parse_line):
    ...
    # words_indexes:实体与关系的字典（实体或者关系：序号），indexes_words与其相反；data(0,1,2):[1]
...
if __name__ == '__main__':
    ...
    headTailSelector, entity2id, id2entity, relation2id, id2relation = build_data(name='WN18RR')
